...
Write-Host "---------------------------------------"
Write-Host ""
Write-Host "Version 0.0.2 | by Pascal Käsler"
Write-Host "---------------------------------------"
Write-Host ""
Write-Host ""
...
switch ($Action) {
	"1" { Clear-Host
          Write-Host "Import der Settings wurde gestartet."
	...
	"2" { Clear-Host
           Write-Host "Export der Settings wurde gestartet"
...
"3" { Write-Host "Passwort setzen"
}
"x" { Clear-Host
      Write-Host "Tschüssikowski"
